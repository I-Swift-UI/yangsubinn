...
struct ImageService {
    ...
    mutating func fetchImageSearchData(start: Int = 1, display: Int = 10, completion: @escaping (NetworkResult<Any>) -> ()) {
    ...
    mutating func fetchImageSearchDataConcurrency(start: Int = 1, display: Int = 10) async throws -> NetworkResult<Any> {
